...
const HomeScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    const storeData = async () => {
      try {
        await AsyncStorage.setItem('asyncItem', 'I like to save my name Sani.');
      } catch (error) {
        // Error saving data
      }
    };
      ...
      <View style={{ padding: '4%' }}>
        ...
        >
          ...
          <TouchableNativeFeedback
            ...
            background={TouchableNativeFeedback.Ripple(COLORS.primary2, true)}
            onPress={() => {
                          ...
                          onPress={() => {
                            {
                              ...
                              CartList.cartList.push(passingData);
                              console.log('cartList from bottom');
